...
final List<Category> categories = [
  ...
  Category(20,"Mythology", icon: FontAwesomeIcons.globe),
  ...
  Category(24,"Politics", icon: FontAwesomeIcons.university),
  Category(25,"Art", icon: FontAwesomeIcons.paintBrush),
  Category(26,"Celebrities", icon: FontAwesomeIcons.heart),
  ...
  Category(31,"Japanese Anime & Manga", icon: FontAwesomeIcons.language),
  Category(32,"Cartoon & Animation", icon: FontAwesomeIcons.cat),
];